...
$urls = "https://hi.wikipedia.org/wiki/विकिपीडिया:विकी_लव्स_वुमन-२०१९";
$dates = "From 10th February 2019 to 31st March 2019";
$subject = "Articles about women in Hindi Wikipedia.";
...
<html ng-app="wikiApp">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $name; ?> Statistics - Hindi Wikipedia Edit a thon Staticstics App</title>
...
<div class="container-fluid" id="mainHd">
  <div class="text-center aspect-ratio" id="mainBox">
    <div class="header">
        ...
        <p>Staticstics of <?php echo $name; ?> in <a href="<?php echo $url;?>">Hindi Wikipedia</a></p>
...
<footer class="footer">
    <div class="container">
      ...
      <p><strong>Data</strong>: From Hindi Wikipedia Labs DB <a href="https://tools.wmflabs.org/">Quarry</a></p>
    </div>
  </footer>
</body>
</html>

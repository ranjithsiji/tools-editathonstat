	  ...
	  $scope.gridOptions = {
			...
			columnDefs: [
			  ...
			  { field: 'Article', minWidth: 200, width: 250, enableColumnResizing: true, type:'string',
				  cellTemplate:'<div>' +
                       '  <a href="https://hi.wikipedia.org/wiki/{{row.entity.Article}}" target="_blank">{{row.entity.Article}}</a>' +
                       '</div>' },
 ...
 $http.get('https://tools.wmflabs.org/editathonstat/wlw19hi/stats.php')

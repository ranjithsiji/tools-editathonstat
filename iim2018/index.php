...
$name="India Independence Movement Edit a Thon 2018";
$urls = "https://ml.wikipedia.org/wiki/WP:IIM2018";
$dates = "From 15th August 2018 to 2nd October 2018";
$subject = "Edit-a-thon related to India Independence Movement.";
$wiki = "Edit-a-thon in Malayalam Wikipedia";
$wikiname = "Malayalam Wikipedia";
?>
<!doctype html>
<html ng-app="wikiApp">
  <head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $name; ?> Statistics - Malayalam Wikipedia Edit a thon Staticstics App</title>
...
<meta name="theme-color" content="#ffffff">
   ...
   <script src="../js/angular-chart.js"></script>
    ...
    .page {
      ...
      #mainHd {background: url('../img/indian-flag.jpg') right bottom fixed; background-size: cover; }
...
<div class="container-fluid" id="mainHd">
  <div class="text-center aspect-ratio" id="mainBox">
    <div class="header">
        ...
        <p>Staticstics of <?php echo $name; ?> in <a href="<?php echo $urls;?>"><?php echo $wikiname;?></a></p>

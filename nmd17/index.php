...
$name="Nelson Mandela Day Edit-a-thon 2017";
$urls = "https://ml.wikipedia.org/wiki/WP:NMD17";
$dates = "From 1st July 2017 to 31st July 2017";
$subject = "Articles about Africa and Nelson Mandela";
...
<meta name="theme-color" content="#ffffff">
   ...
   <script src="../js/angular-chart.js"></script>
    ...
    .page {
      ...
      #mainHd {background: url('../img/mandela.jpg') right bottom fixed; background-size: cover; }

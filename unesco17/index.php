...
<html ng-app="wikiApp">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>World Heritage Edit A Thon Statistics - Malayalam Wikipedia - Wikipedia Edit a thon Staticstics App</title>
...
<meta name="theme-color" content="#ffffff">
   ...
   <script src="../js/angular-chart.js"></script>
    ...
    .page {
      ...
      #mainHd {background: url('../img/unesco.jpg') left center fixed; background-size: cover; }
...
<div class="container-fluid" id="mainHd">
  <div class="text-center aspect-ratio" id="mainBox">
    <div class="header">
        <h1>
          Statistics of World Heritage Edit a Thon 2017
        </h1>

        <p>Staticstics of World Heritage Edit a Thon 2017 in <a href="http://ml.wikipedia.org/wiki/WP:UNESCO17">Malayalam Wikipedia</a></p>
  ...
  <div ng-controller="wikiCtrl">
      <div class="row">
        <div class="col-lg-12 col-sm-12">
            <p class="centerp">From 18th April 2017 to 18th May 2017</p>
      ...
      <div class="row" ng-if="running">
        ...
        <hr/>
          ...
          <p class="editorsQ">Cant Find your Name? <a href="http://ml.wikipedia.org/wiki/WP:UNESCO17">Write an Article to Join Us</a></p>
        </div>
      </div>

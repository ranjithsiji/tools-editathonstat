...
$name="Wiki Loves Women 2019 Edit a Thon";
$urls = "https://bn.wikipedia.org/wiki/উইকিপিডিয়া:উইকি_লাভস_ওমেন_২০১৯";
$dates = "From 10th February 2019 to 31st March 2019";
$subject = "Articles about women in Bengali Wikipedia.";
$wiki = "Bengali Wikipedia";
?>
<!doctype html>
<html ng-app="wikiApp">
  <head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $name; ?> Statistics - Bengali Wikipedia Edit a thon Staticstics App</title>
...
<div class="container-fluid" id="mainHd">
  <div class="text-center aspect-ratio" id="mainBox">
    <div class="header">
        ...
        <p>Staticstics of <?php echo $name; ?> in <a href="<?php echo $url;?>">Bengali Wikipedia</a></p>
...
<footer class="footer">
    <div class="container">
      ...
      <p><strong>Data</strong>: From Bengali Wikipedia Labs DB <a href="https://tools.wmflabs.org/">Quarry</a></p>
    </div>
  </footer>
</body>
</html>
